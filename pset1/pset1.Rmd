...
We created a vector of 10,000 numbers that follow a Normal Distribution and determined the number of those within the vector that fulfill the conditions, x>3.02 or x<2.98. Then, we found the proportion of these out of 10,000.
